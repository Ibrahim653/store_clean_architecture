...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.countryMobileCode, this.mobileNumber,
      this.email, this.profilePicture, this.password);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryMobileCode: $countryMobileCode, mobileNumber: $mobileNumber, email: $email, profilePicture: $profilePicture, password: $password)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userName, countryMobileCode,
      mobileNumber, email, profilePicture, password);
